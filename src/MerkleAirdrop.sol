...
contract MerkleAirdrop is EIP712 {
    ...
    function getMessageHash(address account, uint256 amount) public view returns (bytes32) {
        console.log("message typehash");
        console.logBytes32(MESSAGE_TYPEHASH);
        console.logBytes32(keccak256(abi.encode(MESSAGE_TYPEHASH, AirdropClaim({account: account, amount: amount}))));
